...
const ViewPromo = (props) => {
    ...
    const onFinish = values => {
        ...
        axios.put(
            `http://${process.env.REACT_APP_API}/promotion/${props.promo._id}`, newPromo[0]
    ...
    const onDelete = (id) => {
        axios.delete(
            `http://${process.env.REACT_APP_API}/promotion/${id}`
...
const Promo = () => {
    ...
    const onFinish = values => {
        ...
        axios.post(
            `http://${process.env.REACT_APP_API}/promotions`, newPromo[0]
